...
/**
 * FINAL DOPA TRIAL Q1〜Q4（反転・一段難化プール）：「2番目に大きい数字を押せ！」。
 * 通常の「一番大きい数字を押せ！」に「1段階」を加えるだけの、初見でも理解できる反転問題。
 */
function generate() {
...
function Component({ spec, onResult }: FinalQuestionComponentProps) {
  ...
  return (
    <QuestionShell instruction="2番目に大きい数字を押せ！">
...
export const FinalSecondLargestModule: FinalQuestionModule = {
  id: 'finalSecondLargest',
  tags: ['number', 'reverse'],
  tier: 'reversal',
  generate,
  computeTargetTimeMs,
