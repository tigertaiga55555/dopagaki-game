...
/**
 * ULTIMATE QUESTION候補4（じゃんけん最終形）：「逆順に全部勝て！」を4手に拡張。
 * 既存Q13〜15のFinalRpsReverseSequenceQuestion（3手版）より記憶負荷・処理回数ともに
 * 明確に増やした最終形。「逆順に全部勝て！」の指示は相手の手の並びを見せる前から
 * QuestionShellのinstructionとして常時表示されているため、後出しには絶対にならない。
 */
function generate() {
...
function computeTargetTimeMs() {
  return TIMING_SAFETY.final.ultimate4AnswerMs
}
...
export const FinalUltimateRpsQuadReverseModule: FinalQuestionModule = {
  id: 'finalUltimateRpsQuadReverse',
