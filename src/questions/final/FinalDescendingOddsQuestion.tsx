...
/**
 * FINAL DOPA TRIAL Q5〜Q8（2条件処理プール）：「奇数だけ大きい順に全て押せ！」。
 * FinalAscendingOddsQuestionの逆順版。
 */
function generate() {
  const odds = pickDistinctOdd(3)
  const evens = pickDistinctEven(randInt(2, 3))
  const numbers = shuffle([...odds, ...evens])
  const order = [...odds].sort((a, b) => b - a)
...
export const FinalDescendingOddsModule: FinalQuestionModule = {
  id: 'finalDescendingOdds',
