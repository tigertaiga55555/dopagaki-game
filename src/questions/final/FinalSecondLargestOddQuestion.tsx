...
/**
 * FINAL DOPA TRIAL Q5〜Q8（2条件処理プール）：「2番目に大きい奇数を押せ！」。
 * FinalSecondLargestEvenQuestionの対になる問題（奇数版）。
 */
function generate() {
  const odds = pickDistinct(ODD_DIGITS, 4)
  const evens = pickDistinct(EVEN_DIGITS, randInt(1, 2))
...
function Component({ spec, onResult }: FinalQuestionComponentProps) {
  ...
  return (
    <QuestionShell instruction="2番目に大きい奇数を押せ！">
...
export const FinalSecondLargestOddModule: FinalQuestionModule = {
  id: 'finalSecondLargestOdd',
