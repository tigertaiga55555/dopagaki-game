...
/**
 * FINAL DOPA TRIAL Q5〜Q8（2条件処理プール）：「偶数だけ大きい順に全て押せ！」。
 * FinalAscendingEvensQuestionの逆順版。
 */
function generate() {
  const evens = pickDistinctEven(3)
  const odds = pickDistinctOdd(randInt(2, 3))
  const numbers = shuffle([...evens, ...odds])
  const order = [...evens].sort((a, b) => b - a)
...
export const FinalDescendingEvensModule: FinalQuestionModule = {
  id: 'finalDescendingEvens',
