...
/**
 * Ver.5.0で追加。「点が少ない方を押せ！」：既存の「点が多い方を押せ！」の反対版。
 * 左右に点群を表示し、必ず点数差をつける。
 */
function generate() {
...
function Component({ spec, onResult }: QuestionComponentProps) {
  ...
  return (
    <QuestionShell instruction="点が少ない方を押せ！">
...
export const FewerSideQuestionModule: QuestionModule = {
  id: 'fewerSide',
  category: 'reaction',
  baseTargetTimeMs: 1800,
  generate,
  Component,
  computeMinTargetTimeMs: () => TIMING_SAFETY.reactionMinMs.fewerSide,
}
